...
public class DrawPanel extends JPanel implements MouseListener , MouseMotionListener{
	...
	public void addShape(int shapeType){
		...
		case OVAL:
			...
			break;
		case VTRIANGLE:
			shapes[numShapes++] = new VTriangle(x1,y1,x2,y2,color,color2,filled,gradient,line,vtriType);	
			break;	
		}
		repaint();
	...
	public void mousePressed(MouseEvent e) {
		...
		case OVAL:
			...
			break;
		case VTRIANGLE:
			currentShape = new VTriangle(x1,y1,x2,y2,color,color2,filled,gradient,line,vtriType);	
			break;	
		}
		repaint();
	}
